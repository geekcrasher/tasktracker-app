...
const Header = () => {
  ...
  return (
    <header className=" navbar fixed top-0 z-10 h-20 flex items-center justify-between px-6 bg-[#20252E]">
        <Link to={"/"} className="flex items-center cursor-pointer">
          <ListTodo color="#797D8B" size={20} />
          <span className="font-figtree text-[#797D8B] lg:text-lg ml-2 lowercase">Task</span>
